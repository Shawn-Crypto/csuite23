-- Supabase Database Schema for Production (Final Fixed Version)
-- Complete Indian Investor Course Platform
-- Created: 2025-01-11
-- Fixed: Removed unsupported SECURITY INVOKER syntax
...
-- Create useful views for analytics (Default invoker rights)
